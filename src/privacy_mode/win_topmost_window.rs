...
pub const WIN_TOPMOST_INJECTED_PROCESS_EXE: &'static str = "RuntimeBroker_ganwei_remotedesk.exe";
pub const INJECTED_PROCESS_EXE: &'static str = WIN_TOPMOST_INJECTED_PROCESS_EXE;
pub(super) const PRIVACY_WINDOW_CLASS: &'static str = "GanweiRemoteDeskPrivacyWindowClass";
pub(super) const PRIVACY_WINDOW_NAME: &'static str = "GanweiRemoteDeskPrivacyWindow";
